            ...
            <nav className="main-nav " >
              ...
              <ul className={boxClass.join(' ')}>
                <li className="menu-item " >
                  <NavLink className={({ isActive }) => isActive ? 'is-active' : ''} to={`/`}><MdHome/> Minhas atividades </NavLink> 
                </li>              
                <li className="menu-item " >
                  <NavLink className={({ isActive }) => isActive ? 'is-active' : ''} to={`/jogos/drawing`}><MdVideogameAsset/> Desenho Livre </NavLink> 
                </li>
                <li className="menu-item " >
