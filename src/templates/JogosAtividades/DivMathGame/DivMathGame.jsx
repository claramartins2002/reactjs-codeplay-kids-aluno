...
// Função para gerar questões de divisão com números inteiros e quociente válido
const generateQuestion = () => {
    const divisors = [1, 2, 3, 4, 5, 6, 7, 8, 9]; // Divisores comuns da tabuada
    const divisor = divisors[Math.floor(Math.random() * divisors.length)]; // Número do divisor
    
    // Gera um dividendo que seja múltiplo do divisor
    const dividend = divisor * (Math.floor(Math.random() * 9) + 1); // Multiplica o divisor por um número aleatório (1 a 9)
